...
if (class_exists('TCPDF', false)) {
	...
	include_once DOCUMENT_ROOT.'/application/classes/vendors/pdf_processing/FPDI/fpdi2tcpdf_bridge.php';
}

include_once DOCUMENT_ROOT.'/application/classes/vendors/pdf_processing/FPDI/fpdf_tpl.php';

//require_once('fpdi_pdf_parser.php');
include_once DOCUMENT_ROOT.'/application/classes/vendors/pdf_processing/FPDI/fpdi_pdf_parser.php';
