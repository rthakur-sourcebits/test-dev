	 ...
	 $(document).ready(function() {
		...
		$('#upgrade-btn-'+num).css("display","none");
			...
			<!--Script for change plan Starts-->
				...
				<!--Script for change plan Ends-->

			<div id="normal-view" >
				<div class="span8 mtop20 upgrade-page" id="user-right-content">
    				<div class="portion1">
								<?php
    		            if(!empty($error)) echo "<div class='error_message'>".$error."</div><br/>";
    			        if(!empty($plan_change_message)) {
    				    }
		            ?>
    				...
    				<form action='<?php echo SITEURL?>/admin/changeplan' method="post" id="change_plan" name="admin_form">
    				<?php 
				...
				<a href="<?php echo SITEURL;?>/admin/settings" class="no-thanks-link">
    	...
    	<script>
    		$(document).ready(function(){
			 if($(window).width() < 400) 
    			{
	    			$('.table-wrapper2').css("width","100%");//100
	    			$('.select-deselect-col1').css("width","33%");//18
	    			$('.select-deselect-col1').css("left","66%");//81
	    			$('.select-deselect-col2').css("width","59%");//38
	    			$('.select-deselect-col2').css("left","70%");//83
	    			$('.select-deselect-container1').css("right","64%");//38
	    			$('.select-deselect-col3').css("width","33%");//20
	    			$('.select-deselect-col3').css("left","66%");//83
	    			$('.select-deselect-container2').css("right","0");//22
	    			$('.select-deselect-container3').css("right","0");//20
	    			$('.select-deselect-container2').css("border-right","none");//1px solid #d4d4d4
	    			$('.select-deselect-container3').css("border-right","none");//1px solid #d4d4d4
	    			$('.select-deselect-col4').css("width","42%");//18
	    			$('.select-deselect-col4').css("left","80%");//85
	    			$('.upgrade-downgrade-parent').css("width","100%");//100
	    			$('.upgrade-downgrade-parent').css("margin-top","25%");//0
	    			$('.upgrade-downgrade-col1').css("left","20%");//21
	    			$('.upgrade-downgrade-col1').css("width","100%");//79
	    			$('.upgrade-downgrade-col2').css("width","100%");//19
	    			$('.jqtransform').css("width","100%");//100
	    			$('.jqtransform').css("margin-bottom","6%");//0
	    			$('.left').css("padding-right","0%");//0
			 ...
			 else if(($(window).width() > 600) && ($(window).width() < 900) ) 
				{
				 ...
				 {
	    			$('.table-wrapper2').css("width","100%");//100
	    			$('.select-deselect-col1').css("width","18%");//18
	    			$('.select-deselect-col1').css("left","81%");//81
	    			$('.select-deselect-col2').css("width","38%");//38
	    			$('.select-deselect-col2').css("left","83%");//83
	    			$('.select-deselect-container1').css("right","38%");//38
	    			$('.select-deselect-col3').css("width","20%");//20
	    			$('.select-deselect-col3').css("left","83%");//83
	    			$('.select-deselect-container2').css("right","22%");//22
	    			$('.select-deselect-container3').css("right","20%");//20
	    			$('.select-deselect-container2').css("border-right","1px solid #d4d4d4");//1px solid #d4d4d4
	    			$('.select-deselect-container3').css("border-right","1px solid #d4d4d4");//1px solid #d4d4d4
	    			$('.select-deselect-col4').css("width","18%");//18
	    			$('.select-deselect-col4').css("left","85%");//85
	    			$('.upgrade-downgrade-parent').css("width","100%");//100
	    			$('.upgrade-downgrade-parent').css("margin-top","0%");//0
	    			$('.upgrade-downgrade-col1').css("left","21%");//21
	    			$('.upgrade-downgrade-col1').css("width","79%");//79
	    			$('.upgrade-downgrade-col2').css("width","19%");//19
	    			$('.jqtransform').css("width","100%");//100
	    			$('.jqtransform').css("margin-bottom","0%");//0
	    			$('.left').css("padding-right","0%");//0
