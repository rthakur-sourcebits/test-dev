<div id="my-account">
	<div>
			<a href="#" style="" id="account-button">
				My Account<img src="<?php echo SITEURL?>/media/images/tt-new/caret.png" style=""></span>
			</a>
			
	</div>
 </div>

<div class="popup-menu popup-menu1" id="my-account-menu-normal"><img src="<?php echo SITEURL?>/media/images/tt-new/account-arrow.png" class="my-account-popup-arrow">
	...
	<ul class="myaccount-list">
		...
		<li class="account-list"><a href="<?php echo SITEURL."/company/logout" ?>" class="log-out">Log out</a></li>
	</ul>
</div>