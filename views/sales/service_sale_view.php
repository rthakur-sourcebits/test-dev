...
var sale_item		= <?php echo json_encode($sale_service);?>;
...
<div class="row-fluid margin-2" id="row-fluid" >
	...
	<div class="mobile-icons-cont" style="display:none;">
		<a href="javascript:void(0)" class="left mobile-icons" onclick="delete_sales_cofirm(this.id, 2, '<?php echo $sale[0]['id'];?>');">
	...
	<div class="item-list margin-left-1 margin-right-1">
		...
		<div class="name-salesItem">
			<div class="sales-serviceviewItem7">
				<div class="sales-serviceviewItem6">
					<div class="sales-serviceviewItem5">
						<!--<div class="salesItem4"> -->
						<div class="sales-serviceviewItem3">
							<div class="sales-serviceviewItem-2-field"><label class="salesItem-name-field pad-left-2 font-color">Account</label></div>
							<div class="sales-serviceviewItem-3-field"><label class="salesItem-name-field pad-left-2 font-color">Description</label></div>
							<div class="sales-serviceviewItem-4-field"><label class="salesItem-name-field pad-right-4 font-color">Amount</label></div>
							<!--<div class="salesItem-5-field"><label class="salesItem-name-field font-color">Total</label></div> -->
							<div class="sales-serviceviewItem-6-field"><label class="salesItem-name-field pad-left-2 font-color">Job</label></div>
							<div class="sales-serviceviewItem-7-field"><label class="salesItem-name-field pad-left-2 font-color"><?php echo Kohana::message($_SESSION['CONSTANT_MSG_FILE'], 'taxName');  ?></label></div>
						</div>
					</div>
				<!-- </div> -->
				</div>
		...
		?>
			<div class="name-salesItem1 names_fields_<?php echo $service['id']?>" style="height:42px;">
				<div class="sales-serviceviewItem7">
					<div class="sales-serviceviewItem6">
						<div class="sales-serviceviewItem5">
						<!-- <div class="salesItem4"> -->
						<div class="sales-serviceviewItem3">
								<div class="sales-serviceviewItem-2-field"><label class="salesItem-name-field pad-left-2 font-color1"><?php echo substr($service['account_number'],0,1).'-'.substr($service['account_number'],1); ?></label></div>
								<div class="sales-serviceviewItem-3-field"><label class="salesItem-name-field pad-left-2 font-color1"><?php echo $service['description'];?></label></div>
								<div class="sales-serviceviewItem-4-field"><label class="salesItem-name-field pad-right-4 font-color1">$ <?php echo $service['amount']?></label></div>
								<!--<div class="salesItem-5-field"><label class="salesItem-name-field font-color1">$75.00</label></div> -->
								<div class="sales-serviceviewItem-6-field"><label class="salesItem-name-field pad-left-2 font-color1"><?php echo $service['job_name']?></label></div>
								<div class="sales-serviceviewItem-7-field">
									<?php if( isset($country) && $country == 1) { // for US?>  
	...
	?>
	<div id="sales-phone-version-<?php echo $service['id'];?>" class="item-view toggle-inactive margin-left-1 margin-right-1" style="display:none;" onclick="toggleCustomerSales(this,'<?php echo $service['id'];?>')">
		<div id="arrow-image-field-<?php echo $service['id'];?>" class="phone_fields background-arrow" >
				<label class="heavy sales_label_view"><label class="mar-rig-10 dull phone_view_label">Account</label><?php echo substr($service['account_number'],0,1).'-'.substr($service['account_number'],1); ?></label>
		</div>
		<div id="rest_hidden_contents_<?php echo $service['id'];?>" class="rest_hidden">
			<div class="phone_fields bor-bottom" >
				<label class="heavy sales_label_view"><label class="mar-rig-10 dull phone_view_label">Description</label><?php echo $service['description'];?></label>
			</div>
			<div class="phone_fields bor-bottom" >
				<label class="heavy right_text sales_label_view"><label class="mar-rig-10 dull phone_view_label">Amount</label>$ <?php echo $service['amount']?></label>
			</div>
			<div class="phone_fields bor-bottom" >
				<label class="heavy sales_label_view"><label class="mar-rig-10 dull phone_view_label">Job</label><?php echo $service['job_name']?></label>
			</div>
	...
	<!-- Mobile Version Ends -->
	<!-- Sales Item List starts -->
	<div class="info-column-1 margin-left-1" style="margin-top:12px">
	...
	<div class="info-column-2 margin-right-1" style="margin-top:12px">
		...
		<?php } else { // for US ?>
			...
			<label class="line2 f-left mar-top-neg dull right_align">
				<span class="color-be tabindex_field tax_input number" name="tax_totl" id="tax_totl">$&nbsp;<?php echo number_format($sale[0]['tax_total_amount'],2)."&nbsp;&nbsp;".$sale_service[0]['percentage']."%&nbsp;&nbsp;".$sale_service[0]['tax_code'];?></span>
			</label>
			</div>
		<?php } ?>
		...
		<a href="javascript:void(0);" id="delete2-views" onclick="delete_sales_cofirm('delete-sale', 2, '<?php echo $sale[0]['id'];?>');">
			<div class="delete-btn delete delete-label" style="height:29px;">Delete</div>
		</a>
